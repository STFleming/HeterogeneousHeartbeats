; ModuleID = '/home/sf306/phd_codebase/github/HeterogeneousHeartbeats/hardware/hhb_ip_repository/dummy_hwhb_generator/dummy_hwhb_generator/.autopilot/db/a.g.1.bc'
...
define void @dummy_hwhb_generator(i32* %sensor_bus, i32* %debug1) nounwind uwtable {
  ...
  %start = alloca i32, align 4                    ; [#uses=2 type=i32*]
  call void @llvm.dbg.value(metadata !{i32* %sensor_bus}, i64 0, metadata !901), !dbg !902 ; [debug line = 23:41] [debug variable = sensor_bus]
  call void @llvm.dbg.value(metadata !{i32* %debug1}, i64 0, metadata !903), !dbg !904 ; [debug line = 23:67] [debug variable = debug1]
  call void (...)* @_ssdm_op_SpecBus(i32* %sensor_bus, i8* getelementptr inbounds ([7 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !905 ; [debug line = 26:1]
  call void (...)* @_ssdm_op_SpecResource(i32* %sensor_bus, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !907 ; [debug line = 29:1]
  call void (...)* @_ssdm_op_SpecResource(i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([18 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !908 ; [debug line = 31:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %debug1, i8* getelementptr inbounds ([8 x i8]* @.str5, i64 0, i64 0), i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !909 ; [debug line = 33:1]
  call void (...)* @_ssdm_op_SpecResource(i32* %debug1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([18 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !910 ; [debug line = 34:1]
  call void @llvm.dbg.declare(metadata !{[1 x i32]* %buff}, metadata !911), !dbg !915 ; [debug line = 37:7] [debug variable = buff]
  call void @llvm.dbg.declare(metadata !{i32* %start}, metadata !916), !dbg !917 ; [debug line = 38:7] [debug variable = start]
  store i32 1, i32* %start, align 4, !dbg !918    ; [debug line = 38:16]
  %buff.addr = getelementptr inbounds [1 x i32]* %buff, i64 0, i64 0, !dbg !919 ; [#uses=1 type=i32*] [debug line = 40:3]
  store i32 10, i32* %buff.addr, align 4, !dbg !919 ; [debug line = 40:3]
  %sensor_bus.addr = getelementptr inbounds i32* %sensor_bus, i64 287834117, !dbg !920 ; [#uses=1 type=i32*] [debug line = 41:3]
  %tmp = bitcast i32* %sensor_bus.addr to i8*, !dbg !920 ; [#uses=1 type=i8*] [debug line = 41:3]
  %tmp.1 = bitcast [1 x i32]* %buff to i8*, !dbg !920 ; [#uses=1 type=i8*] [debug line = 41:3]
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp, i8* %tmp.1, i64 4, i32 4, i1 false), !dbg !920 ; [debug line = 41:3]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !921 ; [debug line = 42:3]
  %sensor_bus.addr.1 = getelementptr inbounds i32* %sensor_bus, i64 287834112, !dbg !922 ; [#uses=1 type=i32*] [debug line = 43:3]
  %tmp.2 = bitcast i32* %sensor_bus.addr.1 to i8*, !dbg !922 ; [#uses=1 type=i8*] [debug line = 43:3]
  %tmp.3 = bitcast i32* %start to i8*, !dbg !922  ; [#uses=1 type=i8*] [debug line = 43:3]
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %tmp.2, i8* %tmp.3, i64 4, i32 4, i1 false), !dbg !922 ; [debug line = 43:3]
  ret void, !dbg !923                             ; [debug line = 46:5]
}
...
!901 = metadata !{i32 786689, metadata !832, metadata !"sensor_bus", metadata !833, i32 16777239, metadata !836, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!902 = metadata !{i32 23, i32 41, metadata !832, null}
!903 = metadata !{i32 786689, metadata !832, metadata !"debug1", metadata !833, i32 33554455, metadata !838, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!904 = metadata !{i32 23, i32 67, metadata !832, null}
!905 = metadata !{i32 26, i32 1, metadata !906, null}
!906 = metadata !{i32 786443, metadata !832, i32 23, i32 74, metadata !833, i32 0} ; [ DW_TAG_lexical_block ]
!907 = metadata !{i32 29, i32 1, metadata !906, null}
!908 = metadata !{i32 31, i32 1, metadata !906, null}
!909 = metadata !{i32 33, i32 1, metadata !906, null}
!910 = metadata !{i32 34, i32 1, metadata !906, null}
!911 = metadata !{i32 786688, metadata !906, metadata !"buff", metadata !833, i32 37, metadata !912, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!912 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 32, i64 32, i32 0, i32 0, metadata !56, metadata !913, i32 0, i32 0} ; [ DW_TAG_array_type ]
!913 = metadata !{metadata !914}
!914 = metadata !{i32 786465, i64 0, i64 0}       ; [ DW_TAG_subrange_type ]
!915 = metadata !{i32 37, i32 7, metadata !906, null}
!916 = metadata !{i32 786688, metadata !906, metadata !"start", metadata !833, i32 38, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!917 = metadata !{i32 38, i32 7, metadata !906, null}
!918 = metadata !{i32 38, i32 16, metadata !906, null}
!919 = metadata !{i32 40, i32 3, metadata !906, null}
!920 = metadata !{i32 41, i32 3, metadata !906, null}
!921 = metadata !{i32 42, i32 3, metadata !906, null}
!922 = metadata !{i32 43, i32 3, metadata !906, null}
!923 = metadata !{i32 46, i32 5, metadata !906, null}
