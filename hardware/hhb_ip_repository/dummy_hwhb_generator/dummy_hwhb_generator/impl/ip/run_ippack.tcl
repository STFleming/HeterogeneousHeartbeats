...
set Vendor      "sfleming"
set Library     "HHB"
set IPName      "dummy_hwhb_generator"
set Version     "1.0"
set DisplayName "Dummy_hwhb_generator"
set Revision    "1408071219"
set Description "An IP core that generates random heartbeats for testing registering of heartbeats from the hardware domain"
set Device      "zynq"
set Taxonomy    "/HHB"

## Variables
set Top "dummy_hwhb_generator_top"
...
set Interfaces {
    M_AXI_SENSOR_BUS {
        ...
        mode "master"
        data_width "32"
        port_prefix "m_axi_sensor_bus"
        param_prefix "C_M_AXI_SENSOR_BUS"
    }
    S_AXI_BUS_A {
        type "axi4lite"
        mode "slave"
    ...
    aclk {
        type "clock"
        buses "M_AXI_SENSOR_BUS S_AXI_BUS_A"
    }
    aresetn {
        type "reset"
    }
