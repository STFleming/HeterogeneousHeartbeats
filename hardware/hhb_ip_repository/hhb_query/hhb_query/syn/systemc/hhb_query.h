...
struct hhb_query : public sc_module {
    ...
    sc_in< sc_lv<32> > heartbeat_record_phys_addr;
    ...
    sc_signal< sc_lv<32> > heartbeat_record_phys_addr0data_reg;
    sc_signal< sc_logic > heartbeat_record_phys_addr0vld_reg;
    sc_signal< sc_logic > heartbeat_record_phys_addr0ack_out;
    ...
    sc_signal< sc_lv<32> > buff_0_s_reg_104;
    sc_signal< sc_lv<1> > indvar_reg_117;
    sc_signal< sc_lv<1> > ap_reg_ppstg_indvar_reg_117_pp0_it1;
    ...
    sc_signal< sc_lv<1> > ap_reg_ppstg_indvar_reg_117_pp0_it5;
    sc_signal< bool > ap_sig_bdd_135;
    sc_signal< sc_logic > ap_reg_ppiten_pp0_it6;
    sc_signal< sc_lv<1> > ap_reg_ppstg_indvar_reg_117_pp0_it2;
    sc_signal< sc_lv<1> > ap_reg_ppstg_indvar_reg_117_pp0_it3;
    sc_signal< sc_lv<1> > ap_reg_ppstg_indvar_reg_117_pp0_it4;
    sc_signal< sc_lv<32> > a_addr_reg_151;
    sc_signal< sc_lv<1> > indvar_phi_fu_121_p4;
    sc_signal< sc_lv<64> > tmp_2_fu_141_p1;
    sc_signal< sc_lv<30> > tmp_1_fu_131_p4;
    ...
    void thread_heartbeat_record_phys_addr0ack_out();
    void thread_indvar_phi_fu_121_p4();
    void thread_status();
