...
define void @hhb_query(i32* %a, i32 %heartbeat_record_phys_addr, i32* %current_heartbeat, i32* %status) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32 %heartbeat_record_phys_addr}, i64 0, metadata !18), !dbg !19 ; [debug line = 15:46] [debug variable = heartbeat_record_phys_addr]
  call void @llvm.dbg.value(metadata !{i32 %heartbeat_record_phys_addr}, i64 0, metadata !18), !dbg !19 ; [debug line = 15:46] [debug variable = heartbeat_record_phys_addr]
  call void @llvm.dbg.value(metadata !{i32 %heartbeat_record_phys_addr}, i64 0, metadata !18), !dbg !19 ; [debug line = 15:46] [debug variable = heartbeat_record_phys_addr]
  call void @llvm.dbg.value(metadata !{i32 %heartbeat_record_phys_addr}, i64 0, metadata !18), !dbg !19 ; [debug line = 15:46] [debug variable = heartbeat_record_phys_addr]
  call void @llvm.dbg.value(metadata !{i32 %heartbeat_record_phys_addr}, i64 0, metadata !18), !dbg !19 ; [debug line = 15:46] [debug variable = heartbeat_record_phys_addr]
  ...
  call void @llvm.dbg.declare(metadata !{i32* %heartbeat_record_phys_addr.assign}, metadata !18), !dbg !19 ; [debug line = 15:46] [debug variable = heartbeat_record_phys_addr]
  call void @llvm.dbg.value(metadata !{i32* %current_heartbeat}, i64 0, metadata !20), !dbg !21 ; [debug line = 15:88] [debug variable = current_heartbeat]
  call void @llvm.dbg.value(metadata !{i32* %status}, i64 0, metadata !22), !dbg !23 ; [debug line = 15:121] [debug variable = status]
  ...
  call void (...)* @_ssdm_op_SpecWire(i32* %heartbeat_record_phys_addr.assign, i8* getelementptr inbounds ([8 x i8]* @.str5, i64 0, i64 0), i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !28 ; [debug line = 25:1]
  call void (...)* @_ssdm_op_SpecResource(i32* %heartbeat_record_phys_addr.assign, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([18 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !29 ; [debug line = 26:1]
  ...
  call void @llvm.dbg.value(metadata !{i32* %heartbeat_record_phys_addr.assign}, i64 0, metadata !18), !dbg !39 ; [debug line = 40:3] [debug variable = heartbeat_record_phys_addr]
  call void @llvm.dbg.value(metadata !{i32* %heartbeat_record_phys_addr.assign}, i64 0, metadata !18), !dbg !39 ; [debug line = 40:3] [debug variable = heartbeat_record_phys_addr]
  call void @llvm.dbg.value(metadata !{i32* %heartbeat_record_phys_addr.assign}, i64 0, metadata !18), !dbg !39 ; [debug line = 40:3] [debug variable = heartbeat_record_phys_addr]
  call void @llvm.dbg.value(metadata !{i32* %heartbeat_record_phys_addr.assign}, i64 0, metadata !18), !dbg !39 ; [debug line = 40:3] [debug variable = heartbeat_record_phys_addr]
  call void @llvm.dbg.value(metadata !{i32* %heartbeat_record_phys_addr.assign}, i64 0, metadata !18), !dbg !39 ; [debug line = 40:3] [debug variable = heartbeat_record_phys_addr]
  call void @llvm.dbg.value(metadata !{i32* %heartbeat_record_phys_addr.assign}, i64 0, metadata !18), !dbg !39 ; [debug line = 40:3] [debug variable = heartbeat_record_phys_addr]
  %tmp.1 = lshr i32 %heartbeat_record_phys_addr, 2, !dbg !39 ; [#uses=1 type=i32] [debug line = 40:3]
  ...
  %buff.addr = getelementptr inbounds [1 x i32]* %buff, i64 0, i64 0, !dbg !40 ; [#uses=1 type=i32*] [debug line = 42:3]
  %buff.load = load i32* %buff.addr, align 4, !dbg !40 ; [#uses=2 type=i32] [debug line = 42:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %buff.load) nounwind
  %tmp.4 = add nsw i32 %buff.load, 10, !dbg !40   ; [#uses=1 type=i32] [debug line = 42:3]
  store i32 %tmp.4, i32* %current_heartbeat, align 4, !dbg !40 ; [debug line = 42:3]
  ...
  store i32 1, i32* %status, align 4, !dbg !42    ; [debug line = 44:3]
  ret void, !dbg !43                              ; [debug line = 47:1]
}
...
!18 = metadata !{i32 786689, metadata !5, metadata !"heartbeat_record_phys_addr", metadata !6, i32 33554447, metadata !12, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
...
!21 = metadata !{i32 15, i32 88, metadata !5, null}
!22 = metadata !{i32 786689, metadata !5, metadata !"status", metadata !6, i32 67108879, metadata !13, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!23 = metadata !{i32 15, i32 121, metadata !5, null}
!24 = metadata !{i32 18, i32 1, metadata !25, null}
!25 = metadata !{i32 786443, metadata !5, i32 15, i32 128, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
...
!40 = metadata !{i32 42, i32 3, metadata !25, null}
!41 = metadata !{i32 43, i32 1, metadata !25, null}
!42 = metadata !{i32 44, i32 3, metadata !25, null}
