...
#ifndef _cache_module_hb_cache_AppID_H_
#define _cache_module_hb_cache_AppID_H_
...
struct cache_module_hb_cache_AppID_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(cache_module_hb_cache_AppID_core);
    cache_module_hb_cache_AppID_core(sc_core::sc_module_name) {
    ...
    ~cache_module_hb_cache_AppID_core() {
        delete [] mem;
    }
...
SC_MODULE( cache_module_hb_cache_AppID )
{
    ...
    SC_CTOR( cache_module_hb_cache_AppID ) {
        meminst = new cache_module_hb_cache_AppID_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    cache_module_hb_cache_AppID_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_cache_module_hb_cache_AppID_H_
