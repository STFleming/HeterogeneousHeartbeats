...
`timescale 1ns/1ps
module hwfreqscale_simple_adder_BUS_A_if
#(parameter
    C_ADDR_WIDTH = 6,
    C_DATA_WIDTH = 32
)(
    ...
    // user signals
    output wire [31:0]               I_input1,
    output wire [31:0]               I_input2,
    input  wire [31:0]               O_output_r,
...
localparam
    ...
    ADDR_IER             = 6'h08,
    ADDR_ISR             = 6'h0c,
    ADDR_INPUT1_CTRL     = 6'h10,
    ADDR_INPUT1_DATA_0   = 6'h14,
    ADDR_INPUT2_CTRL     = 6'h18,
    ADDR_INPUT2_DATA_0   = 6'h1c,
    ADDR_OUTPUT_R_CTRL   = 6'h20,
    ADDR_OUTPUT_R_DATA_0 = 6'h24;
...
assign I_input1   = _input1;
assign I_input2   = _input2;
assign _output_r  = O_output_r;
...
always @(posedge ACLK) begin
    if (w_hs && waddr == ADDR_INPUT1_DATA_0)
        _input1[31:0] <= (WDATA[31:0] & wmask) | (_input1[31:0] & ~wmask);
end

// _input2[31:0]
always @(posedge ACLK) begin
    if (w_hs && waddr == ADDR_INPUT2_DATA_0)
        _input2[31:0] <= (WDATA[31:0] & wmask) | (_input2[31:0] & ~wmask);
end
