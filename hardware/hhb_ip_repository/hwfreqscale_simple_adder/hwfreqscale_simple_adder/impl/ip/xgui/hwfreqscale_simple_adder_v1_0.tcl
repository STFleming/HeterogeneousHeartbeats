...
proc init_gui { IPINST } {
	...
	set tabgroup0 [ipgui::add_group $IPINST -parent $Page0 -name {S_AXI_BUS_A (AXI4Lite Slave Interface)} -layout vertical]
	set C_S_AXI_BUS_A_ADDR_WIDTH [ipgui::add_param $IPINST -parent $tabgroup0 -name C_S_AXI_BUS_A_ADDR_WIDTH ]
}
