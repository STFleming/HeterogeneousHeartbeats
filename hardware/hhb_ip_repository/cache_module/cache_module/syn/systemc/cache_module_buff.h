...
#ifndef _cache_module_buff_H_
#define _cache_module_buff_H_
...
struct cache_module_buff_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(cache_module_buff_core);
    cache_module_buff_core(sc_core::sc_module_name) {
...
SC_MODULE( cache_module_buff )
{
    ...
    SC_CTOR( cache_module_buff ) {
        meminst = new cache_module_buff_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    cache_module_buff_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
