...
#(parameter
    ...
    output wire [31:0]               I_app_list_addr,
    input  wire [31:0]               O_debug1,
...
localparam
    ...
    ADDR_IER                  = 6'h08,
    ADDR_ISR                  = 6'h0c,
    ADDR_INAPPID_CTRL         = 6'h10,
    ADDR_INAPPID_DATA_0       = 6'h14,
    ADDR_APP_LIST_ADDR_CTRL   = 6'h18,
    ADDR_APP_LIST_ADDR_DATA_0 = 6'h1c,
    ADDR_DEBUG1_CTRL          = 6'h20,
    ADDR_DEBUG1_DATA_0        = 6'h24;
...
always @(posedge ACLK) begin
    if (ar_hs) begin
        ...
        case (raddr)
            ...
            ADDR_APP_LIST_ADDR_DATA_0: begin
                rdata <= _app_list_addr[31:0];
            end
            ADDR_DEBUG1_DATA_0: begin
                rdata <= _debug1[31:0];
            end
        endcase
    end
...
assign I_app_list_addr = _app_list_addr;
assign _debug1         = O_debug1;
...
// _app_list_addr[31:0]
always @(posedge ACLK) begin
    if (w_hs && waddr == ADDR_APP_LIST_ADDR_DATA_0)
        _app_list_addr[31:0] <= (WDATA[31:0] & wmask) | (_app_list_addr[31:0] & ~wmask);
end
