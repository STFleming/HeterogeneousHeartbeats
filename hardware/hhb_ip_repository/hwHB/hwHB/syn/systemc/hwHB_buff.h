...
#ifndef _hwHB_buff_H_
#define _hwHB_buff_H_
...
struct hwHB_buff_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(hwHB_buff_core);
    hwHB_buff_core(sc_core::sc_module_name) {
...
SC_MODULE( hwHB_buff )
{
    ...
    SC_CTOR( hwHB_buff ) {
        meminst = new hwHB_buff_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    hwHB_buff_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
