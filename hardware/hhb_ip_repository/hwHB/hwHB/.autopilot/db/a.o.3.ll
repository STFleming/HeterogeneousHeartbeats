...
define void @hwHB(i32* %a, i32 %inAppID, i32 %time, i32 %app_list_addr, i32* %debug1) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecIFCore(i32 %app_list_addr, [1 x i8]* @p_str1, [10 x i8]* @p_str3, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [18 x i8]* @p_str4) nounwind, !dbg !50 ; [debug line = 39:1]
