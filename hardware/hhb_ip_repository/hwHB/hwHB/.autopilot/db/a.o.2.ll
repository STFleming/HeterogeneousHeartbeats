...
@.str4 = private unnamed_addr constant [18 x i8] c"-bus_bundle BUS_A\00", align 1 ; [#uses=3 type=[18 x i8]*]
...
define void @hwHB(i32* %a, i32 %inAppID, i32 %time, i32 %app_list_addr, i32* %debug1) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecIFCore(i32 %app_list_addr, [1 x i8]* @.str1, [10 x i8]* @.str3, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [23 x i8]* @.str6) nounwind, !dbg !55 ; [debug line = 39:1]
