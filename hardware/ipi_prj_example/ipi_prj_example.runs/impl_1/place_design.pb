...
%s
*constraints2u
aTime (s): cpu = 00:00:00.20 ; elapsed = 00:00:00.21 . Memory (MB): peak = 1418.133 ; gain = 0.0042default:default
ƒ

Phase %s%s
101*constraints2
...
%s
*constraints2u
aTime (s): cpu = 00:00:00.23 ; elapsed = 00:00:00.24 . Memory (MB): peak = 1418.133 ; gain = 0.0042default:default
k

Phase %s%s
101*constraints2
...
;
/Phase 1.1.4 Build Macros | Checksum: 2447e5025
*common
Œ

%s
*constraints2u
aTime (s): cpu = 00:00:00.64 ; elapsed = 00:00:00.65 . Memory (MB): peak = 1418.133 ; gain = 0.0042default:default
|

Phase %s%s
101*constraints2
...
O
CPhase 1.1.5 Implementation Feasibility check | Checksum: 2447e5025
*common
Œ

%s
*constraints2u
aTime (s): cpu = 00:00:00.88 ; elapsed = 00:00:00.89 . Memory (MB): peak = 1418.133 ; gain = 0.0042default:default
k

Phase %s%s
101*constraints2
...
>
2Phase 1.1.6 Pre-Place Cells | Checksum: 2447e5025
*common
Œ

%s
*constraints2u
aTime (s): cpu = 00:00:00.89 ; elapsed = 00:00:00.90 . Memory (MB): peak = 1418.133 ; gain = 0.0042default:default
Ž

Phase %s%s
101*constraints2
...
a
UPhase 1.1.7 IO Placement/ Clock Placement/ Build Placer Device | Checksum: 1ad286e5f
*common
†

%s
...
C
7Phase 1.1.8.1.1 Build Clock Data | Checksum: 1d2e82f94
*common
‡

%s
...
B
6Phase 1.1.8.1 Place Init Design | Checksum: 29d82d1ac
*common
‡

%s
...
\Time (s): cpu = 00:00:04 ; elapsed = 00:00:02 . Memory (MB): peak = 1429.141 ; gain = 11.0122default:default
I
=Phase 1.1.8 Build Placer Netlist Model | Checksum: 29d82d1ac
*common
‡

%s
...
Q
EPhase 1.1.9.1 Constrain Global/Regional Clocks | Checksum: 29d82d1ac
*common
‡

%s
...
\Time (s): cpu = 00:00:04 ; elapsed = 00:00:02 . Memory (MB): peak = 1429.141 ; gain = 11.0122default:default
F
:Phase 1.1.9 Constrain Clocks/Macros | Checksum: 29d82d1ac
*common
‡

%s
...
\Time (s): cpu = 00:00:04 ; elapsed = 00:00:02 . Memory (MB): peak = 1429.141 ; gain = 11.0122default:default
G
;Phase 1.1 Placer Initialization Core | Checksum: 29d82d1ac
*common
‡

%s
...
\Time (s): cpu = 00:00:04 ; elapsed = 00:00:02 . Memory (MB): peak = 1429.141 ; gain = 11.0122default:default
@
4Phase 1 Placer Initialization | Checksum: 29d82d1ac
*common
‡

%s
...
9
-Phase 2.1 Run Budgeter | Checksum: 24fa69bd9
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:07 ; elapsed = 00:00:04 . Memory (MB): peak = 1444.141 ; gain = 26.0122default:default
;
/Phase 2 Global Placement | Checksum: 1eb431995
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:23 ; elapsed = 00:00:08 . Memory (MB): peak = 1445.141 ; gain = 27.0122default:default
h

Phase %s%s
101*constraints2
...
G
;Phase 3.1 Commit Multi Column Macros | Checksum: 1eb431995
*common
‡

%s
...
I
=Phase 3.2 Commit Most Macros & LUTRAMs | Checksum: 1d4333933
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:25 ; elapsed = 00:00:09 . Memory (MB): peak = 1454.148 ; gain = 36.0202default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 25d985f10
*common
‡

%s
...
B
6Phase 3.4 Timing Path Optimizer | Checksum: 20ca69142
*common
‡

%s
...
M
APhase 3.5 Commit Small Macros & Core Logic | Checksum: 19ca6ffdd
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:26 ; elapsed = 00:00:10 . Memory (MB): peak = 1467.277 ; gain = 49.1482default:default
l

Phase %s%s
101*constraints2
...
?
3Phase 3.6 Re-assign LUT pins | Checksum: 19ca6ffdd
*common
‡

%s
...
\Time (s): cpu = 00:00:26 ; elapsed = 00:00:10 . Memory (MB): peak = 1467.277 ; gain = 49.1482default:default
;
/Phase 3 Detail Placement | Checksum: 19ca6ffdd
*common
‡

%s
...
@
4Phase 4.1 PCOPT Shape updates | Checksum: 10b8f0458
*common
‡

%s
...
Q
EPhase 4.2.1 Post Placement Timing Optimization | Checksum: 1c9c6163f
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:28 ; elapsed = 00:00:11 . Memory (MB): peak = 1467.277 ; gain = 49.1482default:default
H
<Phase 4.2 Post Placement Optimization | Checksum: 1c9c6163f
*common
‡

%s
...
C
7Phase 4.3 Post Placement Cleanup | Checksum: 1c9c6163f
*common
‡

%s
...
C
7Phase 4.4.1 Congestion Reporting | Checksum: 1c9c6163f
*common
‡

%s
...
A
5Phase 4.4.2 updateTiming final | Checksum: 11406c2ac
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:29 ; elapsed = 00:00:11 . Memory (MB): peak = 1467.277 ; gain = 49.1482default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 4.4.3 Dump Critical Paths  | Checksum: 11406c2ac
*common
‡

%s
...
:
.Phase 4.4.4 Restore STA | Checksum: 11406c2ac
*common
‡

%s
...
2*	placeflow20
| WNS=11.692 | TNS=0.000  |
2default:defaultZ30-100
>
2Phase 4.4.5 Print Final WNS | Checksum: 11406c2ac
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:31 ; elapsed = 00:00:12 . Memory (MB): peak = 1467.277 ; gain = 49.1482default:default
=
1Phase 4.4 Placer Reporting | Checksum: 11406c2ac
*common
‡

%s
...
D
8Phase 4.5 Final Placement Cleanup | Checksum: 1391fe17a
*common
‡

%s
...
\Time (s): cpu = 00:00:31 ; elapsed = 00:00:12 . Memory (MB): peak = 1467.277 ; gain = 49.1482default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 1391fe17a
*common
‡

%s
...
\Time (s): cpu = 00:00:31 ; elapsed = 00:00:12 . Memory (MB): peak = 1467.277 ; gain = 49.1482default:default
5
)Ending Placer Task | Checksum: 105c798bf
*common
‡

%s
...
‚
vreport_utilization: Time (s): cpu = 00:00:00.65 ; elapsed = 00:00:00.76 . Memory (MB): peak = 1470.277 ; gain = 0.000
*common
m
