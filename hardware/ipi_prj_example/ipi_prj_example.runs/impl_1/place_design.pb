...
%s
*constraints2u
aTime (s): cpu = 00:00:00.18 ; elapsed = 00:00:00.18 . Memory (MB): peak = 1418.133 ; gain = 0.0042default:default
ƒ

Phase %s%s
101*constraints2
...
%s
*constraints2u
aTime (s): cpu = 00:00:00.19 ; elapsed = 00:00:00.19 . Memory (MB): peak = 1418.133 ; gain = 0.0042default:default
k

Phase %s%s
101*constraints2
...
;
/Phase 1.1.4 Build Macros | Checksum: 1bf1ca782
*common
Œ

%s
*constraints2u
aTime (s): cpu = 00:00:00.60 ; elapsed = 00:00:00.60 . Memory (MB): peak = 1418.133 ; gain = 0.0042default:default
|

Phase %s%s
101*constraints2
...
O
CPhase 1.1.5 Implementation Feasibility check | Checksum: 1bf1ca782
*common
Œ

%s
*constraints2u
aTime (s): cpu = 00:00:00.84 ; elapsed = 00:00:00.85 . Memory (MB): peak = 1418.133 ; gain = 0.0042default:default
k

Phase %s%s
101*constraints2
...
>
2Phase 1.1.6 Pre-Place Cells | Checksum: 1bf1ca782
*common
Œ

%s
*constraints2u
aTime (s): cpu = 00:00:00.86 ; elapsed = 00:00:00.86 . Memory (MB): peak = 1418.133 ; gain = 0.0042default:default
Ž

Phase %s%s
101*constraints2
...
a
UPhase 1.1.7 IO Placement/ Clock Placement/ Build Placer Device | Checksum: 127c6c5bc
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:02 ; elapsed = 00:00:02 . Memory (MB): peak = 1424.141 ; gain = 6.0122default:default
v

Phase %s%s
101*constraints2
...
C
7Phase 1.1.8.1.1 Build Clock Data | Checksum: 1de8e8f2f
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:04 ; elapsed = 00:00:02 . Memory (MB): peak = 1429.141 ; gain = 11.0122default:default
B
6Phase 1.1.8.1 Place Init Design | Checksum: 14fee7d53
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:04 ; elapsed = 00:00:03 . Memory (MB): peak = 1429.141 ; gain = 11.0122default:default
I
=Phase 1.1.8 Build Placer Netlist Model | Checksum: 14fee7d53
*common
‡

%s
...
Q
EPhase 1.1.9.1 Constrain Global/Regional Clocks | Checksum: 14fee7d53
*common
‡

%s
...
\Time (s): cpu = 00:00:04 ; elapsed = 00:00:03 . Memory (MB): peak = 1429.141 ; gain = 11.0122default:default
F
:Phase 1.1.9 Constrain Clocks/Macros | Checksum: 14fee7d53
*common
‡

%s
...
\Time (s): cpu = 00:00:04 ; elapsed = 00:00:03 . Memory (MB): peak = 1429.141 ; gain = 11.0122default:default
G
;Phase 1.1 Placer Initialization Core | Checksum: 14fee7d53
*common
‡

%s
...
\Time (s): cpu = 00:00:04 ; elapsed = 00:00:03 . Memory (MB): peak = 1429.141 ; gain = 11.0122default:default
@
4Phase 1 Placer Initialization | Checksum: 14fee7d53
*common
‡

%s
...
9
-Phase 2.1 Run Budgeter | Checksum: 2250eee8b
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:08 ; elapsed = 00:00:04 . Memory (MB): peak = 1445.141 ; gain = 27.0122default:default
;
/Phase 2 Global Placement | Checksum: 21c176871
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:25 ; elapsed = 00:00:09 . Memory (MB): peak = 1446.141 ; gain = 28.0122default:default
h

Phase %s%s
101*constraints2
...
G
;Phase 3.1 Commit Multi Column Macros | Checksum: 21c176871
*common
‡

%s
...
I
=Phase 3.2 Commit Most Macros & LUTRAMs | Checksum: 19b5b7381
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:27 ; elapsed = 00:00:10 . Memory (MB): peak = 1456.148 ; gain = 38.0202default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 1ad4431b0
*common
‡

%s
...
B
6Phase 3.4 Timing Path Optimizer | Checksum: 17a4357d3
*common
‡

%s
...
M
APhase 3.5 Commit Small Macros & Core Logic | Checksum: 1b7c3d68c
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:28 ; elapsed = 00:00:11 . Memory (MB): peak = 1468.277 ; gain = 50.1482default:default
l

Phase %s%s
101*constraints2
...
?
3Phase 3.6 Re-assign LUT pins | Checksum: 1b7c3d68c
*common
‡

%s
...
\Time (s): cpu = 00:00:28 ; elapsed = 00:00:11 . Memory (MB): peak = 1468.277 ; gain = 50.1482default:default
;
/Phase 3 Detail Placement | Checksum: 1b7c3d68c
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:29 ; elapsed = 00:00:11 . Memory (MB): peak = 1468.277 ; gain = 50.1482default:default
€

Phase %s%s
101*constraints2
...
@
4Phase 4.1 PCOPT Shape updates | Checksum: 2d841ec78
*common
‡

%s
...
Q
EPhase 4.2.1 Post Placement Timing Optimization | Checksum: 1e114a175
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:30 ; elapsed = 00:00:12 . Memory (MB): peak = 1468.277 ; gain = 50.1482default:default
H
<Phase 4.2 Post Placement Optimization | Checksum: 1e114a175
*common
‡

%s
...
C
7Phase 4.3 Post Placement Cleanup | Checksum: 1e114a175
*common
‡

%s
...
C
7Phase 4.4.1 Congestion Reporting | Checksum: 1e114a175
*common
‡

%s
...
A
5Phase 4.4.2 updateTiming final | Checksum: 20eaaa21d
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:31 ; elapsed = 00:00:12 . Memory (MB): peak = 1468.277 ; gain = 50.1482default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 4.4.3 Dump Critical Paths  | Checksum: 20eaaa21d
*common
‡

%s
...
:
.Phase 4.4.4 Restore STA | Checksum: 20eaaa21d
*common
‡

%s
...
2*	placeflow20
| WNS=12.735 | TNS=0.000  |
2default:defaultZ30-100
>
2Phase 4.4.5 Print Final WNS | Checksum: 20eaaa21d
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:35 ; elapsed = 00:00:13 . Memory (MB): peak = 1468.277 ; gain = 50.1482default:default
=
1Phase 4.4 Placer Reporting | Checksum: 20eaaa21d
*common
‡

%s
...
D
8Phase 4.5 Final Placement Cleanup | Checksum: 180d87cd9
*common
‡

%s
...
\Time (s): cpu = 00:00:35 ; elapsed = 00:00:13 . Memory (MB): peak = 1468.277 ; gain = 50.1482default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 180d87cd9
*common
‡

%s
...
\Time (s): cpu = 00:00:35 ; elapsed = 00:00:13 . Memory (MB): peak = 1468.277 ; gain = 50.1482default:default
5
)Ending Placer Task | Checksum: 151dd9ff9
*common
‡

%s
...
‚
vreport_utilization: Time (s): cpu = 00:00:00.71 ; elapsed = 00:00:00.80 . Memory (MB): peak = 1472.277 ; gain = 0.000
*common
m
