...
localparam
    ...
    ADDR_IER           = 5'h08,
    ADDR_ISR           = 5'h0c,
    ADDR_DEBUG1_CTRL   = 5'h10,
    ADDR_DEBUG1_DATA_0 = 5'h14;
...
// _debug1[31:0]
always @(posedge ACLK) begin
    if (w_hs && waddr == ADDR_DEBUG1_DATA_0)
        _debug1[31:0] <= (WDATA[31:0] & wmask) | (_debug1[31:0] & ~wmask);
end
