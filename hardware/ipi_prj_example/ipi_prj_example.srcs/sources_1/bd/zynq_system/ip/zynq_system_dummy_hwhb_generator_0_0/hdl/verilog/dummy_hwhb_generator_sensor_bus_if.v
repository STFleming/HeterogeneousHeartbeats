...
//------------------------Instantiation------------------
// dummy_hwhb_generator_sensor_bus_request_preprocessor
dummy_hwhb_generator_sensor_bus_request_preprocessor #(
...
// dummy_hwhb_generator_sensor_bus_write
dummy_hwhb_generator_sensor_bus_write #(
...
// dummy_hwhb_generator_sensor_bus_read
dummy_hwhb_generator_sensor_bus_read #(
    .C_ID_WIDTH        ( C_ID_WIDTH ),
    .C_ADDR_WIDTH      ( C_ADDR_WIDTH ),
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
...
//------------------------Instantiation------------------
// dummy_hwhb_generator_sensor_bus_fifo
dummy_hwhb_generator_sensor_bus_fifo #(
...
//------------------------Instantiation------------------
// dummy_hwhb_generator_sensor_bus_read_data_align
dummy_hwhb_generator_sensor_bus_read_data_align #(
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
    .C_USER_DATA_WIDTH ( C_USER_DATA_WIDTH )
) data_align (
...
module dummy_hwhb_generator_sensor_bus_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
//------------------------Instantiation------------------
// dummy_hwhb_generator_sensor_bus_reg_slice
dummy_hwhb_generator_sensor_bus_reg_slice #(
    .N       ( BUS_DATA_WIDTH )
) rs0 (
    .sclk    ( ACLK ),
...
module dummy_hwhb_generator_sensor_bus_reg_slice/*{{{*/
#(parameter
    N = 8   // data width
) (
    // system signals
