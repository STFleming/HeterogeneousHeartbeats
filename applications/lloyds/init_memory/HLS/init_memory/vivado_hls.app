<project xmlns="com.autoesl.autopilot.project" name="init_memory" top="init_memory_top">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        ...
        <file name="../../simulation/init_memory_tb.cpp" sc="0" tb="1" cflags=" "/>
        ...
        <file name="sources/init_memory_top.h" sc="0" tb="false" cflags=""/>
