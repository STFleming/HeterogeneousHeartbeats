...
#ifndef _load_points_buffer_int_buffer_H_
#define _load_points_buffer_int_buffer_H_
...
struct load_points_buffer_int_buffer_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(load_points_buffer_int_buffer_core);
    load_points_buffer_int_buffer_core(sc_core::sc_module_name) {
    ...
    ~load_points_buffer_int_buffer_core() {
        delete [] mem;
    }
...
SC_MODULE( load_points_buffer_int_buffer )
{
    ...
    SC_CTOR( load_points_buffer_int_buffer ) {
        meminst = new load_points_buffer_int_buffer_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    load_points_buffer_int_buffer_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_load_points_buffer_int_buffer_H_
