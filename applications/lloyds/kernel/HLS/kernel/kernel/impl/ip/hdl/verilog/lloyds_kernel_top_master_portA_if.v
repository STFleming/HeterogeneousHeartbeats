...
//------------------------Instantiation------------------
// lloyds_kernel_top_master_portA_request_preprocessor
lloyds_kernel_top_master_portA_request_preprocessor #(
...
// lloyds_kernel_top_master_portA_write
lloyds_kernel_top_master_portA_write #(
...
// lloyds_kernel_top_master_portA_read
lloyds_kernel_top_master_portA_read #(
    .C_ID_WIDTH        ( C_ID_WIDTH ),
    .C_ADDR_WIDTH      ( C_ADDR_WIDTH ),
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
...
//------------------------Instantiation------------------
// lloyds_kernel_top_master_portA_fifo
lloyds_kernel_top_master_portA_fifo #(
...
//------------------------Instantiation------------------
// lloyds_kernel_top_master_portA_read_data_align
lloyds_kernel_top_master_portA_read_data_align #(
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
    .C_USER_DATA_WIDTH ( C_USER_DATA_WIDTH )
) data_align (
...
module lloyds_kernel_top_master_portA_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
//------------------------Instantiation------------------
// lloyds_kernel_top_master_portA_reg_slice
lloyds_kernel_top_master_portA_reg_slice #(
    .N       ( BUS_DATA_WIDTH )
) rs0 (
    .sclk    ( ACLK ),
...
module lloyds_kernel_top_master_portA_reg_slice/*{{{*/
#(parameter
    N = 8   // data width
) (
    // system signals
