...
void load_centres_buffer_int_buffer::proc_mem_q()
{
...
void load_centres_buffer_int_buffer::proc_mem_ra()
{
...
void load_centres_buffer_int_buffer::proc_mem_ce()
{
    sc_lv<2> tmp;
    tmp[1] = ce0.read();
    tmp[0] = ce1.read();
...
void load_centres_buffer_int_buffer::proc_mem_wa()
{
...
void load_centres_buffer_int_buffer::proc_mem_we()
{
    sc_lv<1> tmp;
    tmp[0] = we0.read();
    mem_we.write(tmp);
...
void load_centres_buffer_int_buffer::proc_mem_d()
{
...
void load_centres_buffer_int_buffer::proc_op()
{
...
void load_centres_buffer_int_buffer::proc_addr()
{
...
// check collision
void load_centres_buffer_int_buffer::proc_check()
{
    int f = 0;
    for (int i = 0; i < 1; i++) {
        for (int j = i + 1; j < 2; j++) {
