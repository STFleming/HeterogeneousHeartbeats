...
#ifndef _lloyds_kernel_top_output_buffer_min_idx_V_H_
#define _lloyds_kernel_top_output_buffer_min_idx_V_H_
...
struct lloyds_kernel_top_output_buffer_min_idx_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(lloyds_kernel_top_output_buffer_min_idx_V_core);
    lloyds_kernel_top_output_buffer_min_idx_V_core(sc_core::sc_module_name) {
    ...
    ~lloyds_kernel_top_output_buffer_min_idx_V_core() {
        delete [] mem;
    }
...
SC_MODULE( lloyds_kernel_top_output_buffer_min_idx_V )
{
    ...
    SC_CTOR( lloyds_kernel_top_output_buffer_min_idx_V ) {
        meminst = new lloyds_kernel_top_output_buffer_min_idx_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    lloyds_kernel_top_output_buffer_min_idx_V_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_lloyds_kernel_top_output_buffer_min_idx_V_H_
