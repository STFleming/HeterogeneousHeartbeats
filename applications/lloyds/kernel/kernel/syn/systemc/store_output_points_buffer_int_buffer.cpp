...
void store_output_points_buffer_int_buffer::proc_mem_q()
{
...
void store_output_points_buffer_int_buffer::proc_mem_ra()
{
...
void store_output_points_buffer_int_buffer::proc_mem_ce()
{
    sc_lv<1> tmp;
    tmp[0] = ce1.read();
    mem_ce.write(tmp);
...
void store_output_points_buffer_int_buffer::proc_mem_wa()
{
...
void store_output_points_buffer_int_buffer::proc_mem_we()
{
    sc_lv<2> tmp;
    tmp[1] = we0.read();
    tmp[0] = we1.read();
...
void store_output_points_buffer_int_buffer::proc_mem_d()
{
...
void store_output_points_buffer_int_buffer::proc_op()
{
    __re__[0].write((sc_logic)0);
...
void store_output_points_buffer_int_buffer::proc_addr()
{
...
// check collision
void store_output_points_buffer_int_buffer::proc_check()
{
    int f = 0;
    for (int i = 0; i < 1; i++) {
        for (int j = i + 1; j < 2; j++) {
