...
#ifndef _store_output_buffer_int_buffer_H_
#define _store_output_buffer_int_buffer_H_
...
struct store_output_buffer_int_buffer_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(store_output_buffer_int_buffer_core);
    store_output_buffer_int_buffer_core(sc_core::sc_module_name) {
    ...
    ~store_output_buffer_int_buffer_core() {
        delete [] mem;
    }
...
SC_MODULE( store_output_buffer_int_buffer )
{
    ...
    SC_CTOR( store_output_buffer_int_buffer ) {
        meminst = new store_output_buffer_int_buffer_core <1, 2, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    store_output_buffer_int_buffer_core <1, 2, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_store_output_buffer_int_buffer_H_
