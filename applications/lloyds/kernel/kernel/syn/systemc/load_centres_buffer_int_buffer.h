...
#ifndef _load_centres_buffer_int_buffer_H_
#define _load_centres_buffer_int_buffer_H_
...
struct load_centres_buffer_int_buffer_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(load_centres_buffer_int_buffer_core);
    load_centres_buffer_int_buffer_core(sc_core::sc_module_name) {
    ...
    ~load_centres_buffer_int_buffer_core() {
        delete [] mem;
    }
...
SC_MODULE( load_centres_buffer_int_buffer )
{
    static const unsigned int DataWidth = 32;
    static const unsigned int AddressRange = 768;
    ...
    SC_CTOR( load_centres_buffer_int_buffer ) {
        meminst = new load_centres_buffer_int_buffer_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    load_centres_buffer_int_buffer_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_load_centres_buffer_int_buffer_H_
