...
#ifndef _lloyds_kernel_top_centres_buffer_0_value_H_
#define _lloyds_kernel_top_centres_buffer_0_value_H_
...
struct lloyds_kernel_top_centres_buffer_0_value_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(lloyds_kernel_top_centres_buffer_0_value_core);
    lloyds_kernel_top_centres_buffer_0_value_core(sc_core::sc_module_name) {
    ...
    ~lloyds_kernel_top_centres_buffer_0_value_core() {
        delete [] mem;
    }
...
SC_MODULE( lloyds_kernel_top_centres_buffer_0_value )
{
    ...
    SC_CTOR( lloyds_kernel_top_centres_buffer_0_value ) {
        meminst = new lloyds_kernel_top_centres_buffer_0_value_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    lloyds_kernel_top_centres_buffer_0_value_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_lloyds_kernel_top_centres_buffer_0_value_H_
