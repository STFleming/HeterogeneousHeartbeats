...
set ID 22
set MemName store_output_buffer_int_buffer
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 24 \
    name buffer_min_idx_V \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename buffer_min_idx_V \
    op interface \
    ports { buffer_min_idx_V_address0 { O 4 vector } buffer_min_idx_V_ce0 { O 1 bit } buffer_min_idx_V_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buffer_min_idx_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename buffer_sum_sq \
    op interface \
    ports { buffer_sum_sq_address0 { O 4 vector } buffer_sum_sq_ce0 { O 1 bit } buffer_sum_sq_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buffer_sum_sq'"
}
}
