...
module combiner_top_master_portB_if/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// combiner_top_master_portB_request_preprocessor
combiner_top_master_portB_request_preprocessor #(
...
// combiner_top_master_portB_write
combiner_top_master_portB_write #(
...
// combiner_top_master_portB_read
combiner_top_master_portB_read #(
    .C_ID_WIDTH        ( C_ID_WIDTH ),
    .C_ADDR_WIDTH      ( C_ADDR_WIDTH ),
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
...
module combiner_top_master_portB_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
//------------------------Instantiation------------------
// combiner_top_master_portB_fifo
combiner_top_master_portB_fifo #(
...
module combiner_top_master_portB_write/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
module combiner_top_master_portB_read/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// combiner_top_master_portB_read_data_align
combiner_top_master_portB_read_data_align #(
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
    .C_USER_DATA_WIDTH ( C_USER_DATA_WIDTH )
) data_align (
...
module combiner_top_master_portB_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
//------------------------Instantiation------------------
// combiner_top_master_portB_reg_slice
combiner_top_master_portB_reg_slice #(
    .N       ( BUS_DATA_WIDTH )
) rs0 (
    .sclk    ( ACLK ),
...
module combiner_top_master_portB_fifo/*{{{*/
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module combiner_top_master_portB_reg_slice/*{{{*/
#(parameter
    N = 8   // data width
) (
    // system signals
