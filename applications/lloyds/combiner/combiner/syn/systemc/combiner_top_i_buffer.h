...
#ifndef _combiner_top_i_buffer_H_
#define _combiner_top_i_buffer_H_
...
struct combiner_top_i_buffer_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(combiner_top_i_buffer_core);
    combiner_top_i_buffer_core(sc_core::sc_module_name) {
...
SC_MODULE( combiner_top_i_buffer )
{
    ...
    SC_CTOR( combiner_top_i_buffer ) {
        meminst = new combiner_top_i_buffer_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    combiner_top_i_buffer_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_combiner_top_i_buffer_H_
