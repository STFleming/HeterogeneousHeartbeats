...
#ifndef _combiner_top_centre_buffer_0_wgtCent_value_H_
#define _combiner_top_centre_buffer_0_wgtCent_value_H_
...
struct combiner_top_centre_buffer_0_wgtCent_value_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(combiner_top_centre_buffer_0_wgtCent_value_core);
    combiner_top_centre_buffer_0_wgtCent_value_core(sc_core::sc_module_name) {
    ...
    ~combiner_top_centre_buffer_0_wgtCent_value_core() {
        delete [] mem;
    }
...
SC_MODULE( combiner_top_centre_buffer_0_wgtCent_value )
{
    ...
    SC_CTOR( combiner_top_centre_buffer_0_wgtCent_value ) {
        meminst = new combiner_top_centre_buffer_0_wgtCent_value_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    combiner_top_centre_buffer_0_wgtCent_value_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_combiner_top_centre_buffer_0_wgtCent_value_H_
