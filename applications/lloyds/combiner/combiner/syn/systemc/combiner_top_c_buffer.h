...
#define _combiner_top_c_buffer_H_
...
struct combiner_top_c_buffer_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(combiner_top_c_buffer_core);
    combiner_top_c_buffer_core(sc_core::sc_module_name) {
...
SC_MODULE( combiner_top_c_buffer )
{
