...
set id 1
set name combiner_top_sdiv_32ns_32ns_32_35
...
set ID 4
set MemName combiner_top_centre_buffer_0_wgtCent_value
...
# Memory (RAM/ROM)  definition:
set ID 5
set MemName combiner_top_i_buffer
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 32
...
# Memory (RAM/ROM)  definition:
set ID 6
set MemName combiner_top_p_buffer
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 48
