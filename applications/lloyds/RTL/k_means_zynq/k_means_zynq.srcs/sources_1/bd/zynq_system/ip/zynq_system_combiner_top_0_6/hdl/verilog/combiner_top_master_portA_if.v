...
//------------------------Instantiation------------------
// combiner_top_master_portA_request_preprocessor
combiner_top_master_portA_request_preprocessor #(
...
// combiner_top_master_portA_write
combiner_top_master_portA_write #(
...
// combiner_top_master_portA_read
combiner_top_master_portA_read #(
    .C_ID_WIDTH        ( C_ID_WIDTH ),
    .C_ADDR_WIDTH      ( C_ADDR_WIDTH ),
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
...
module combiner_top_master_portA_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
//------------------------Instantiation------------------
// combiner_top_master_portA_fifo
combiner_top_master_portA_fifo #(
...
//------------------------Instantiation------------------
// combiner_top_master_portA_read_data_align
combiner_top_master_portA_read_data_align #(
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
    .C_USER_DATA_WIDTH ( C_USER_DATA_WIDTH )
) data_align (
...
module combiner_top_master_portA_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
//------------------------Instantiation------------------
// combiner_top_master_portA_reg_slice
combiner_top_master_portA_reg_slice #(
    .N       ( BUS_DATA_WIDTH )
) rs0 (
    .sclk    ( ACLK ),
