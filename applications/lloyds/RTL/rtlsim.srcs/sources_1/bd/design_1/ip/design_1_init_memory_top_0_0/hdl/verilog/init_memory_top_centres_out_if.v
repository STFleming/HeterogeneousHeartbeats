...
module init_memory_top_centres_out_if/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// init_memory_top_centres_out_request_preprocessor
init_memory_top_centres_out_request_preprocessor #(
...
// init_memory_top_centres_out_write
init_memory_top_centres_out_write #(
...
// init_memory_top_centres_out_read
init_memory_top_centres_out_read #(
    .C_ID_WIDTH        ( C_ID_WIDTH ),
    .C_ADDR_WIDTH      ( C_ADDR_WIDTH ),
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
...
module init_memory_top_centres_out_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
//------------------------Instantiation------------------
// init_memory_top_centres_out_fifo
init_memory_top_centres_out_fifo #(
...
module init_memory_top_centres_out_write/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
module init_memory_top_centres_out_read/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// init_memory_top_centres_out_read_data_align
init_memory_top_centres_out_read_data_align #(
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
    .C_USER_DATA_WIDTH ( C_USER_DATA_WIDTH )
) data_align (
...
module init_memory_top_centres_out_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
//------------------------Instantiation------------------
// init_memory_top_centres_out_reg_slice
init_memory_top_centres_out_reg_slice #(
    .N       ( BUS_DATA_WIDTH )
) rs0 (
    .sclk    ( ACLK ),
...
module init_memory_top_centres_out_fifo/*{{{*/
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module init_memory_top_centres_out_reg_slice/*{{{*/
#(parameter
    N = 8   // data width
) (
    // system signals
